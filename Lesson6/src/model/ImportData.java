...
//        oleg.speak();
        ...
        citizens.add(petya);
        Person vasiliy2 = new Person("man", 18, "Vasiliy", 177);
        Address addressVas2 = new Address("Belarus", "Brest");
        vasiliy.setAddress(addressVas2);
        citizens.add(vasiliy2);
        Person oleg2 = new Person("man", 20, "Oleg", 184);
        Address addressOleg2 = new Address("Belarus", "Minsk");
        oleg.setAddress(addressOleg2);
        citizens.add(oleg2);
        return citizens;
    }
}
